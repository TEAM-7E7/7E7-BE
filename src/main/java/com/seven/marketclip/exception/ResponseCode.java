...
public enum ResponseCode implements Serializable {
    ...
    REVIEW_MAKE_GOODS_NOT_FOUND(NOT_FOUND, "해당 게시글을 찾을 수 없습니다."),
    CHAT_MAKE_GOODS_NOT_FOUND(NOT_FOUND, "해당 게시글을 찾을 수 없습니다."),
    CHAT2_MAKE_GOODS_NOT_FOUND(NOT_FOUND, "해당 게시글을 찾을 수 없습니다."),
